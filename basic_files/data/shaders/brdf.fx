...
const float3 rvt = float3(1/2.2, 1/2.2, 1/2.2);
...
float4 BRDF_PS(VS_OUTPUT input) : COLOR {
    ...
    albedo = lerp(mask.rgb, albedo, mask.a);
    ...
    float3 specular = numerator / denominator + prefilteredColor * F; // numerator / denominator + ;
